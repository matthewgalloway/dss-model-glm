# This file is the actual code for the custom Python algorithm generalised-linear-model_glm-regression
...
class CustomPredictionAlgorithm(BaseCustomPredictionAlgorithm):    
    """
        Class defining the behaviour of `generalised-linear-model_glm-regression` algorithm:
